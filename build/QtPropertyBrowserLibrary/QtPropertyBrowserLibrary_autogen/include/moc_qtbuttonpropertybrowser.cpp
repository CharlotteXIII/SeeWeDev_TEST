...
#include <memory>
#include "../../../../QtPropertyBrowserLibrary/qtpropertybrowser/qtbuttonpropertybrowser.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QtButtonPropertyBrowser_t, stringdata0) + ofs), len 
...
const QMetaObject QtButtonPropertyBrowser::staticMetaObject = { {
    ...
    qt_meta_stringdata_QtButtonPropertyBrowser.offsetsAndSize,
    qt_meta_data_QtButtonPropertyBrowser,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QtButtonPropertyBrowser_t
, QtPrivate::TypeAndForceComplete<QtButtonPropertyBrowser, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QtBrowserItem *, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QtBrowserItem *, std::false_type>
