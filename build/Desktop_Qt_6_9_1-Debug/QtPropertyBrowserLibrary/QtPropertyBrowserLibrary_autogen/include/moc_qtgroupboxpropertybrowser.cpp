...
#include "../../../../../QtPropertyBrowserLibrary/qtpropertybrowser/qtgroupboxpropertybrowser.h"
...
namespace {
struct qt_meta_tag_ZN25QtGroupBoxPropertyBrowserE_t {};
} // unnamed namespace

template <> constexpr inline auto QtGroupBoxPropertyBrowser::qt_create_metaobjectdata<qt_meta_tag_ZN25QtGroupBoxPropertyBrowserE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QtGroupBoxPropertyBrowser, qt_meta_tag_ZN25QtGroupBoxPropertyBrowserE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject QtGroupBoxPropertyBrowser::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN25QtGroupBoxPropertyBrowserE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN25QtGroupBoxPropertyBrowserE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN25QtGroupBoxPropertyBrowserE_t>.metaTypes,
    nullptr
} };
...
void *QtGroupBoxPropertyBrowser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN25QtGroupBoxPropertyBrowserE_t>.strings))
