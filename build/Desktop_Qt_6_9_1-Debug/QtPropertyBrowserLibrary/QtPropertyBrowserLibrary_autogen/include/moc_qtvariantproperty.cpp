...
template <> constexpr inline auto QtVariantPropertyManager::qt_create_metaobjectdata<qt_meta_tag_ZN24QtVariantPropertyManagerE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "slotFilePathFilterChanged",
        "slotFilePathModeChanged",
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'slotValueChanged'
        QtMocHelpers::SlotData<void(QtProperty *, QDate)>(12, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 2 }, { QMetaType::QDate, 2 },
        }}),
        // Slot 'slotRangeChanged'
        QtMocHelpers::SlotData<void(QtProperty *, QDate, QDate)>(13, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 2 }, { QMetaType::QDate, 2 }, { QMetaType::QDate, 2 },
        }}),
        // Slot 'slotValueChanged'
        QtMocHelpers::SlotData<void(QtProperty *, QTime)>(12, 2, QMC::AccessPrivate, QMetaType::Void, {{
        ...
        // Slot 'slotFilePathFilterChanged'
        QtMocHelpers::SlotData<void(QtProperty *, const QString &)>(26, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 2 }, { QMetaType::QString, 2 },
        }}),
        // Slot 'slotFilePathModeChanged'
        QtMocHelpers::SlotData<void(QtProperty *, const QString &)>(27, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 2 }, { QMetaType::QString, 2 },
        }}),
        // Slot 'slotPropertyInserted'
        QtMocHelpers::SlotData<void(QtProperty *, QtProperty *, QtProperty *)>(28, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 2 }, { 0x80000000 | 3, 2 }, { 0x80000000 | 3, 2 },
        }}),
        // Slot 'slotPropertyRemoved'
        QtMocHelpers::SlotData<void(QtProperty *, QtProperty *)>(29, 2, QMC::AccessPrivate, QMetaType::Void, {{
